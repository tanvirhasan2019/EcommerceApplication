...
const empty_cart = <h1 style={{textAlign:'center'}}>Your Cart is empty </h1>;
            ...
            <Layout>
               ...
               <div className="row cart-header">
                ...
                {cost > 0 ?
                    (
                        <div className="row">
                            <div className="col-md-8 col-sm cart-item-list">

                                <ProductlistinCart />
                            </div>


                            <div className="col-md-4 col-sm total-price-display"
